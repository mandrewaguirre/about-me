...
if (question1 === 'Y' || question1 === 'YES' ){
  ...
  alert ('I did, their names were Sunny, Scritch, Sammy, Scratch!' + ' ' + question1 + ' Corret ' + counterRight);
} else {
  counterWrong ++;
...
while (guessNumberGame < 4 ) {
  question6 = parseInt(prompt ('Guess a number between 1 and 20, I\'ll give you 4 tries'));
